...
$env.config = {
  ...
  cursor_shape: {
    ...
    vi_insert: blink_line # block, underscore, line (block is the default)
    vi_normal: blink_block # block, underscore, line  (underscore is the default)
  }
